...
def get_total_price(pc):
    ...
    total_price += 0 if pc.cpu == None else pc.cpu.cpu.price
    total_price += 0 if pc.ram == None else pc.ram.ram.price
    total_price += 0 if pc.gpu == None else pc.gpu.gpu.price
